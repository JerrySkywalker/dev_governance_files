...
.EXAMPLE
  .\setup_project_matlab_mcp.ps1 -ProjectRoot "V:\src\thesis-code" -OverwriteMatlabSection
...
$tomlArgs = ($argItems | ForEach-Object { "  " + (ConvertTo-TomlBasicString -Text $_) }) -join ",`r`n"
